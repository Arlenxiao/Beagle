...
namespace NewLife.Cube.Beagle
{
    ...
    public static class HtmlExtensions
    {
        ...
        /// <returns></returns>
        public static MvcHtmlString ForEditorX(this HtmlHelper Html, String name, Object value, Type type = null, String format = null, Object htmlAttributes = null)
        {
            ...
            switch (Type.GetTypeCode(type))
            {
                case TypeCode.Boolean:
                    return Html.ForBooleanX(name, value.ToBoolean(), htmlAttributes);
                case TypeCode.DateTime:
                    return Html.ForDateTimeX(name, value.ToDateTime(), format, htmlAttributes);
                case TypeCode.Decimal:
                    return Html.ForDecimalX(name, Convert.ToDecimal(value), format, htmlAttributes);
                case TypeCode.Single:
                case TypeCode.Double:
                    return Html.ForDoubleX(name, value.ToDouble(), format, htmlAttributes);
                case TypeCode.Byte:
                case TypeCode.SByte:
                case TypeCode.Int16:
                case TypeCode.Int32:
                ...
                case TypeCode.UInt64:
                    if (type.IsEnum)
                        return Html.ForEnumX(name, value ?? 0.ChangeType(type), format);
                    else
                        return Html.ForIntX(name, Convert.ToInt64(value), format, htmlAttributes);
                case TypeCode.String:
                    return Html.ForStringX(name, value + "", 0, htmlAttributes);
                default:
                    return Html.ForObjectX(name, value);
            }
        }
        ...
        /// <param name="htmlAttributes"></param>
        /// <returns></returns>
        public static MvcHtmlString ForEditorX<TModel, TProperty>(this HtmlHelper<TModel> Html, Expression<Func<TModel, TProperty>> expression, Object htmlAttributes = null)
        {
        ...
        /// <returns></returns>
        public static MvcHtmlString ForEditorX(this HtmlHelper Html, FieldItem field, IEntity entity = null)
        {
            ...
            // 优先处理映射。因为映射可能是字符串
            {
                ...
                try
                {
                    var mhs = ForMapX(Html, field, entity);
            ...
            {
                var mhs = ForTreeEditorX(Html, field, entity as IEntityTree);
                if (mhs != null) return mhs;
            }
            ...
            return Html.ForEditorX(field.Name, entity[field.Name], field.Type);
        }

        private static MvcHtmlString ForTreeEditorX(HtmlHelper Html, FieldItem field, IEntityTree entity)
        {
            ...
            return Html.DropDownList(field.Name, data, new { @class = "select2" });
        }

        private static MvcHtmlString ForMapX(HtmlHelper Html, FieldItem field, IEntity entity)
        {
            var map = field.Map;
            ...
            return Html.ForDropDownListX(map.Name, map.Provider.GetDataSource(), entity[map.Name]);
        }
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public static MvcHtmlString ForEditorX(this HtmlHelper Html, String name, IEntity entity = null)
        {
            if (entity == null) entity = Html.ViewData.Model as IEntity;
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static MvcHtmlString ForObjectX(this HtmlHelper Html, String name, Object value)
        {
        ...
        /// <param name="htmlAttributes"></param>
        /// <returns></returns>
        public static MvcHtmlString ForStringX(this HtmlHelper Html, String name, String value, Int32 length = 0, Object htmlAttributes = null)
        {
            ...
            //       "<button class=\"btn btn-secondary active\"><i class=\"icon-th mdi mdi-calendar\"></i></button>" +
            //   "</div>" +
           ...
           var ico = "";
            ...
            {
                ico = "<div class=\"input-group-append\"><button class=\"btn btn-secondary active\"><i class=\"mdi mdi-phone\"></i></button></div>";
            ...
            {
                ico = "<div class=\"input-group-append\"><button class=\"btn btn-secondary active\"><i class=\"mdi mdi-smartphone\"></i></button></div>";
                if (!atts.ContainsKey("type")) atts.Add("type", "tel");
                txt = Html.TextBox(name, value, atts);
            }
            else if (name.EqualIgnoreCase("email", "mail"))
            {
                ico = "<div class=\"input-group-append\"><button class=\"btn btn-secondary active\"><i class=\"mdi mdi-email\"></i></button></div>";
                if (!atts.ContainsKey("type")) atts.Add("type", "email");
                txt = Html.TextBox(name, value, atts);
            }
            else if (name.EndsWithIgnoreCase("url"))
            {
                ico = "<div class=\"input-group-append\"><button class=\"btn btn-secondary active\"><i class=\"mdi mdi-home\"></i></button></div>";
            ...
            var icog = "<div class=\"input-group mb-3\">{0}</div>";
        ...
        /// <param name="htmlAttributes"></param>
        /// <returns></returns>
        public static MvcHtmlString ForIntX(this HtmlHelper Html, String name, Int64 value, String format = null, Object htmlAttributes = null)
        {
            var atts = HtmlHelper.AnonymousObjectToHtmlAttributes(htmlAttributes);
            if (!atts.ContainsKey("class")) atts.Add("class", "form-control");
        ...
        /// <param name="htmlAttributes"></param>
        /// <returns></returns>
        public static MvcHtmlString ForDateTimeX(this HtmlHelper Html, String name, DateTime value, String format = null, Object htmlAttributes = null)
        {
            ...
            //if (!atts.ContainsKey("class")) atts.Add("class", "input-group date datetimepicker");
            ...
            // 首先输出图标
            //var ico = Html.Raw("<span class=\"btn btn-secondary active\"><i class=\"icon-th mdi mdi-calendar\"></i></span>");

            //var txt = Html.TextBox(name, obj, format, atts);
            //var txt = BuildInput(InputType.Text, name, obj, atts);

            var html = "<div class=\"input-group date datetimepicker\" data-date-format=\"" + format + "\">" +
                "<div class=\"input-group-append\">" +
                    "<button class=\"btn btn-secondary active\"><i class=\"icon-th mdi mdi-calendar\"></i></button>" +
                "</div>" +
                "<input class=\"form-control col-12 col-sm-7 col-md-5 col-lg-4 col-xl-3\" style=\"width: 180px;\" type=\"text\" value=\"" + obj + "\" name=\""+ name + "\" id=\""+ name + "\">" +
            "</div>";
        ...
        /// <param name="htmlAttributes"></param>
        /// <returns></returns>
        public static MvcHtmlString ForDateTimeX<TModel, TProperty>(this HtmlHelper<TModel> Html, Expression<Func<TModel, TProperty>> expression, String format = null, Object htmlAttributes = null)
        {
            var meta = ModelMetadata.FromLambdaExpression(expression, Html.ViewData);
        ...
        /// <param name="htmlAttributes"></param>
        /// <returns></returns>
        public static MvcHtmlString ForBooleanX(this HtmlHelper Html, String name, Boolean value, Object htmlAttributes = null)
        {
            //var atts = HtmlHelper.AnonymousObjectToHtmlAttributes(htmlAttributes);
            ...
            var html = "<div class=\"be-checkbox custom-control custom-checkbox\">" +
                "<input class=\"custom-control-input\" type=\"checkbox\" id=\"" + name + "\" name=\"" + value + "\" value=\"{1}\">" +
                "<label class=\"custom-control-label\" for=\"" + name + "\"></label></div>";
        ...
        /// <param name="htmlAttributes"></param>
        /// <returns></returns>
        public static MvcHtmlString ForDecimalX(this HtmlHelper Html, String name, Decimal value, String format = null, Object htmlAttributes = null)
        {
            var atts = HtmlHelper.AnonymousObjectToHtmlAttributes(htmlAttributes);
            if (!atts.ContainsKey("class")) atts.Add("class", "form-control");
            //<div class="input-group-prepend"><span class="input-group-text">$</span></div>
            // 首先输出图标
            var ico = Html.Raw("<span class=\"input-group-prepend\"><i class=\"input-group-text\"></i></span>");
        ...
        /// <param name="htmlAttributes"></param>
        /// <returns></returns>
        public static MvcHtmlString ForDoubleX(this HtmlHelper Html, String name, Double value, String format = null, Object htmlAttributes = null)
        {
            var atts = HtmlHelper.AnonymousObjectToHtmlAttributes(htmlAttributes);
            if (!atts.ContainsKey("class")) atts.Add("class", "form-control");
        ...
        /// <param name="field"></param>
        /// <returns></returns>
        public static MvcHtmlString ForDescriptionX(this HtmlHelper Html, FieldItem field)
        {
        ...
        /// <param name="name"></param>
        /// <returns></returns>
        public static MvcHtmlString ForDescriptionX(this HtmlHelper Html, String name)
        {
            var entity = Html.ViewData.Model as IEntity;
        ...
        /// <returns></returns>
        public static MvcHtmlString ForEnumX(this HtmlHelper Html, String name, Object value, String label = null)
        {
            ...
            var hmstr = Html.DropDownList(name, data, label, new { @class = "select2" });
        ...
        /// <returns></returns>
        public static MvcHtmlString ForEnumX<T>(this HtmlHelper Html, String name, Boolean selectAll = false, Boolean autoPostback = false)
        {
            ...
            return Html.ForListBoxX(name, dic, values, autoPostback);
        }
        #endregion
        ...
        /// <param name="autoPostback">自动回发</param>
        /// <returns></returns>
        public static MvcHtmlString ForDropDownListX(this HtmlHelper Html, String name, IEnumerable items, Object selectedValue = null, String optionLabel = null, Boolean autoPostback = false)
        {
        ...
        /// <param name="autoPostback">自动回发</param>
        /// <returns></returns>
        public static MvcHtmlString ForDropDownListX(this HtmlHelper Html, String name, IList<IEntity> list, String optionLabel = null, Boolean autoPostback = false)
        {
            var entity = Html.ViewData.Model as IEntity;
        ...
        /// <param name="autoPostback">自动回发</param>
        /// <returns></returns>
        public static MvcHtmlString ForListBoxX(this HtmlHelper Html, String name, IDictionary dic, IEnumerable selectedValues, Boolean autoPostback = false)
        {
        ...
        /// <param name="autoPostback">自动回发</param>
        /// <returns></returns>
        public static MvcHtmlString ForListBoxX(this HtmlHelper Html, String name, IList<IEntity> list, Boolean autoPostback = false)
        {
            var entity = Html.ViewData.Model as IEntity;
